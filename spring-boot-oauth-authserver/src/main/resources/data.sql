...
insert into oauth_client (id,client_id,client_secret,client_name,redirect_uri_list,authorized_grant_types,created_at,updated_at,privacy_policy,terms_of_service)
 values (null,'app.lms.1','y8X2Yio05kHiTsisYE68','wholesale-books','http://wholesale.in:8181/login/oauth2/code/lms','authorization_code',current_timestamp(),current_timestamp(),'http://localhost:8181/privacy','http://localhost:8181/termsofservice');
